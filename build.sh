...
sudo cardano-cli address build --payment-script-file plutus/lending.plutus --stake-verification-key-file keys/stake.vkey $MAGIC --out-file plutus/lending.addr
